...
/*
  3번째 바이트 속도조절 (0x00~0xFE, 0~260km/h)
  0x440,0,STD,8,{0x00,0x00,0x00,0x04,0xFF,0x2A,0x0B,0x00}
*/
{ 0x440,0,STD,8,{0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF} },


/*
  2번째 바이트 기어조절
  0x?0-> P단기어, 0x?5->D단 변경, 0x?6->N단 변경, 0x?7->R단 변경 (?:Don't care bit)
...
/*
  4번째 바이트 RPM조절 (0x10->1000rpm, 0x50->5000rpm)
  0x316,0,STD,8,{0x01,0x23,0x9C,0x0C,0x23,0x1C,0x00,0x7E} 
*/
{ 0x316,0,STD,8,{0x00,0x00,0x00,0x50,0x00,0x00,0x00,0x00} },



{ 0x280,0,STD,8,{0x00,0x00,0x78,0x00,0x00,0x00,0x00,0x00} },
